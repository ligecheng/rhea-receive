...
public class CrcDutils {
    ...
    public static void main(String[] args) {
        ...
        String stc=TenTohexDutils.hex(-12346L);
        byte[]get=stc.getBytes();
        int srs=calcCrc16(get);
        Long l=(long)srs;
        System.out.println("==========="+TenTohexDutils.hex(l)+"========="+srs);
        int crc = CrcDutils.calcCrc16(new byte[] { 0x02, 0x05, 0x00, 0x03, (byte) 0xff, 0x00 });
        System.out.println(String.format("0x%04x", crc)+"==============="+crc);
        byte []data=new byte[] { 0x02, 0x05, 0x00, 0x03, (byte) 0xff, 0x00 };
        int cst=calcCrc16(data,0, data.length,crc);
        System.out.print("校验结果"+cst);
    }
